...
<?php
  if(isset($_POST['location'])){
    header("Location: location spot.php");
...
<script src="https://chatwee-api.com/v2/script/60add71cc61cfd422d4345e2.js"></script>
  ...
  <body>
    ...
    <div id="div1">
     ...
     <div id="maindiv">
     <h4>SELECT YOUR NEAREST LOCATION</h4>
     <div id="vendor">

      <label><div class="fig">
        <img src="icon/l1.jpg" style="width:100%; height:100%;">
        <p id="venlabel">BANGLORE</p>
        <input type="submit" value="Banglore" name="location"></div></label>
      
      <label><div class="fig">
        <img src="icon/l2.jpg" style="width:100%; height:100%;">
        <p id="venlabel">MUMBAI</p>
        <input type="submit" value="Mumbai" name="location"></div></label>
      
      <label><div class="fig">
        <img src="icon/l3.jpg" style="width:100%; height:100%;">
        <p id="venlabel">PUNE</p>
        <input type="submit" value="Pune" name="location"></div></label>
      
      <label><div class="fig">
        <img src="icon/l4.jpg" style="width:100%; height:100%;">
        <p id="venlabel">HYDERABAD</p>
        <input type="submit" value="Hyderabad" name="location"></div></label>
      
      <label><div class="fig">
        <img src="icon/l5.jpg" style="width:100%; height:100%;">
        <p id="venlabel">CHENNAI</p>
        <input type="submit" value="Chennai" name="location"></div></label>
